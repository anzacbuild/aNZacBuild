...
base='aNZac Wizard'
ADDON=xbmcaddon.Addon(id='plugin.program.anzacwizard')
...
EXCLUDES     = ['plugin.program.anzacwizard']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/anzacbuild/aNZacBuild/master/Wizard/Wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("aNZac Wizard","aNZac Build Wizard",'', 'Turn on the engines')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting your choosen aNZac Build now, Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING aNZac Wizard will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
